...
const posts = [
  { id: 1, img: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=400&q=80', likes: '2.4K' },
  { id: 2, img: 'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?w=400&q=80', likes: '1.8K' },
  ...
  return (
    <section className="insta" id="instagram">
      ...
      <div className="insta__header">
        ...
        >
          Tag us @sunkeycare to be featured on our page
        </motion.p>
      </div>
      ...
      <div className="insta__grid">
        {posts.map((post, i) => (
          ...
          >
            <img src={post.img} alt={`Instagram post ${post.id}`} className="insta__img" loading="lazy" />
